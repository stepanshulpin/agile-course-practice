...
enum Status {
    ...
    READY("Press Search"),
    BAD_ARRAY_FORMAT("Bad array format, please enter array of ints, comma separated"),
    BAD_ARRAY_SORT("Array not sorted, but array must be sorted"),
    BAD_ELEMENT_FORMAT("Bad element format, please enter the key to search");
