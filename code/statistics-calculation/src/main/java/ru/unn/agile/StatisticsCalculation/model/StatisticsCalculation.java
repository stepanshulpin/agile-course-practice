...
public class StatisticsCalculation {
    public static double calculateExpectedValue(final Number[] values, final Double[] probabilities) {
        DistributionChecker.checkArraysInitialization(values);
        DistributionChecker.checkArraysInitialization(probabilities);
        DistributionChecker.checkArraysSize(values, probabilities);
        Double result = 0.0;
